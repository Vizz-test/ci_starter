...
<head>
    ...
    <title>Sign Up | Invest on your own</title>
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-6 d-none d-lg-block text-center text-dark">
                                <img src="<?= base_url().'images/intrinsic_logo_blue.png' ?>" class="w-100 img-responsive img-fluid d-block mx-auto" alt="">
                            </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="p-5">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <a class="small" href="<?= base_url().'user/login'?>">Already have an Account?</a>
